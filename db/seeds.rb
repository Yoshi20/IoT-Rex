...
EventTemplate.create(text: 'TestEventTemplate11111', notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 1), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11')]) unless EventTemplate.find_by(text: 'TestEventTemplate11111').present?
EventTemplate.create(text: 'TestEventTemplate11112', notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 1), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11'), OrganisationUnit.find_by(name: 'TestOrganisationUnit12')]) unless EventTemplate.find_by(text: 'TestEventTemplate11112').present?
EventTemplate.create(text: 'TestEventTemplate11113', notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 1), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11'), OrganisationUnit.find_by(name: 'TestOrganisationUnit12'), OrganisationUnit.find_by(name: 'TestOrganisationUnit13')]) unless EventTemplate.find_by(text: 'TestEventTemplate11113').present?
...
EventTemplate.create(text: 'TestEventTemplate11121', notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 2), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11')]) unless EventTemplate.find_by(text: 'TestEventTemplate11121').present?
EventTemplate.create(text: 'TestEventTemplate11122', notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 2), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11'), OrganisationUnit.find_by(name: 'TestOrganisationUnit12')]) unless EventTemplate.find_by(text: 'TestEventTemplate11122').present?
EventTemplate.create(text: 'TestEventTemplate11123', notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 2), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11'), OrganisationUnit.find_by(name: 'TestOrganisationUnit12'), OrganisationUnit.find_by(name: 'TestOrganisationUnit13')]) unless EventTemplate.find_by(text: 'TestEventTemplate11123').present?
