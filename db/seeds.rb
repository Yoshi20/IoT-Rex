...
EventConfiguration.create(text: 'TestEventConfiguration00114', level: 3, acknowledged_event_id: nil, notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 6), organisation_units: [OrganisationUnit.find_by(name: 'IoT-Rex')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration00114').present?
...
EventConfiguration.create(text: 'TestEventConfiguration00112', level: 2, acknowledged_event_id: EventConfiguration.find_by(text: 'TestEventConfiguration00113').id, timeout: 20, timeout_event_id: EventConfiguration.find_by(text: 'TestEventConfiguration00114').id, notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 6), organisation_units: [OrganisationUnit.find_by(name: 'IoT-Rex')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration00112').present?
EventConfiguration.create(text: 'TestEventConfiguration00111', level: 1, acknowledged_event_id: EventConfiguration.find_by(text: 'TestEventConfiguration00112').id, notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 6), organisation_units: [OrganisationUnit.find_by(name: 'IoT-Rex')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration00111').present?
...
EventConfiguration.create(text: 'TestEventConfiguration11113', level: 3, acknowledged_event_id: nil, notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 1), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11'), OrganisationUnit.find_by(name: 'TestOrganisationUnit12'), OrganisationUnit.find_by(name: 'TestOrganisationUnit13')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration11113').present?
EventConfiguration.create(text: 'TestEventConfiguration11112', level: 2, acknowledged_event_id: EventConfiguration.find_by(text: 'TestEventConfiguration11113').id, notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 1), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11'), OrganisationUnit.find_by(name: 'TestOrganisationUnit12')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration11112').present?
EventConfiguration.create(text: 'TestEventConfiguration11111', level: 1, acknowledged_event_id: EventConfiguration.find_by(text: 'TestEventConfiguration11112').id, notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 1), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration11111').present?
...
EventConfiguration.create(text: 'TestEventConfiguration11123', level: 3, acknowledged_event_id: nil, notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 2), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11'), OrganisationUnit.find_by(name: 'TestOrganisationUnit12'), OrganisationUnit.find_by(name: 'TestOrganisationUnit13')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration11123').present?
EventConfiguration.create(text: 'TestEventConfiguration11122', level: 2, acknowledged_event_id: EventConfiguration.find_by(text: 'TestEventConfiguration11123').id, notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 2), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11'), OrganisationUnit.find_by(name: 'TestOrganisationUnit12')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration11122').present?
EventConfiguration.create(text: 'TestEventConfiguration11121', level: 1, acknowledged_event_id: EventConfiguration.find_by(text: 'TestEventConfiguration11122').id, notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 2), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration11121').present?
