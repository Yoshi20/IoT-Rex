...
EventConfiguration.create(text: 'TestEventConfiguration11111', notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 1), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration11111').present?
EventConfiguration.create(text: 'TestEventConfiguration11112', notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 1), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11'), OrganisationUnit.find_by(name: 'TestOrganisationUnit12')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration11112').present?
EventConfiguration.create(text: 'TestEventConfiguration11113', notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 1), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11'), OrganisationUnit.find_by(name: 'TestOrganisationUnit12'), OrganisationUnit.find_by(name: 'TestOrganisationUnit13')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration11113').present?
...
EventConfiguration.create(text: 'TestEventConfiguration11121', notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 2), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration11121').present?
EventConfiguration.create(text: 'TestEventConfiguration11122', notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 2), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11'), OrganisationUnit.find_by(name: 'TestOrganisationUnit12')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration11122').present?
EventConfiguration.create(text: 'TestEventConfiguration11123', notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 2), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11'), OrganisationUnit.find_by(name: 'TestOrganisationUnit12'), OrganisationUnit.find_by(name: 'TestOrganisationUnit13')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration11123').present?
