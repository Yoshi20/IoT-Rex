...
DeviceConfiguration.create(name: 'TestDeviceConfiguration001', device_type: DeviceType.find_by(name: 'LoRa-Panel'), organisation_unit: OrganisationUnit.find_by(name: 'IoT-Rex')) unless DeviceConfiguration.find_by(name: 'TestDeviceConfiguration001').present?
EventTrigger.create(button_number: 6, lora_message_type: LoraMessageType.find_by(message_id: '22'), device_configuration: DeviceConfiguration.find_by(name: 'TestDeviceConfiguration001')) unless EventTrigger.find_by(button_number: 6).present?
EventConfiguration.create(text: 'TestEventConfiguration00114', level: 3, acknowledged_event_configuration_id: nil, notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 6), organisation_units: [OrganisationUnit.find_by(name: 'IoT-Rex')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration00114').present?
EventConfiguration.create(text: 'TestEventConfiguration00113', level: 3, acknowledged_event_configuration_id: nil, notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 6), organisation_units: [OrganisationUnit.find_by(name: 'IoT-Rex')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration00113').present?
EventConfiguration.create(text: 'TestEventConfiguration00112', level: 2, acknowledged_event_configuration_id: EventConfiguration.find_by(text: 'TestEventConfiguration00113').id, timeout: 20, timeout_event_configuration_id: EventConfiguration.find_by(text: 'TestEventConfiguration00114').id, notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 6), organisation_units: [OrganisationUnit.find_by(name: 'IoT-Rex')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration00112').present?
EventConfiguration.create(text: 'TestEventConfiguration00111', level: 1, acknowledged_event_configuration_id: EventConfiguration.find_by(text: 'TestEventConfiguration00112').id, notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 6), organisation_units: [OrganisationUnit.find_by(name: 'IoT-Rex')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration00111').present?
Device.create(name: 'TestDevice01', dev_eui: '01', organisation: Organisation.find_by(name: 'Embedded Science'), device_type: DeviceType.find_by(name: 'LoRa-Panel'),     organisation_unit_id: OrganisationUnit.find_by(name: 'IoT-Rex').id, device_configuration_id: DeviceConfiguration.find_by(name: 'TestDeviceConfiguration001').id) unless Device.find_by(name: 'TestDevice01').present?
Device.create(name: 'TestDevice02', dev_eui: '02', organisation: Organisation.find_by(name: 'Embedded Science'), device_type: DeviceType.find_by(name: 'LoRa-EPD-4Btns'), organisation_unit_id: OrganisationUnit.find_by(name: 'IoT-Rex').id) unless Device.find_by(name: 'TestDevice02').present?
Device.create(name: 'TestDevice03', dev_eui: '03', organisation: Organisation.find_by(name: 'Embedded Science'), device_type: DeviceType.find_by(name: 'LoRa-Wristband')) unless Device.find_by(name: 'TestDevice03').present?
...
EventConfiguration.create(text: 'TestEventConfiguration11113', level: 3, acknowledged_event_configuration_id: nil, notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 1), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11'), OrganisationUnit.find_by(name: 'TestOrganisationUnit12'), OrganisationUnit.find_by(name: 'TestOrganisationUnit13')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration11113').present?
EventConfiguration.create(text: 'TestEventConfiguration11112', level: 2, acknowledged_event_configuration_id: EventConfiguration.find_by(text: 'TestEventConfiguration11113').id, notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 1), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11'), OrganisationUnit.find_by(name: 'TestOrganisationUnit12')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration11112').present?
EventConfiguration.create(text: 'TestEventConfiguration11111', level: 1, acknowledged_event_configuration_id: EventConfiguration.find_by(text: 'TestEventConfiguration11112').id, notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 1), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration11111').present?
...
EventConfiguration.create(text: 'TestEventConfiguration11123', level: 3, acknowledged_event_configuration_id: nil, notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 2), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11'), OrganisationUnit.find_by(name: 'TestOrganisationUnit12'), OrganisationUnit.find_by(name: 'TestOrganisationUnit13')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration11123').present?
EventConfiguration.create(text: 'TestEventConfiguration11122', level: 2, acknowledged_event_configuration_id: EventConfiguration.find_by(text: 'TestEventConfiguration11123').id, notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 2), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11'), OrganisationUnit.find_by(name: 'TestOrganisationUnit12')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration11122').present?
EventConfiguration.create(text: 'TestEventConfiguration11121', level: 1, acknowledged_event_configuration_id: EventConfiguration.find_by(text: 'TestEventConfiguration11122').id, notification_channel: NotificationChannel.find_by(name: 'app'), event_trigger: EventTrigger.find_by(button_number: 2), organisation_units: [OrganisationUnit.find_by(name: 'TestOrganisationUnit11')]) unless EventConfiguration.find_by(text: 'TestEventConfiguration11121').present?
