...
class UserGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_group" do
    assert_difference('UserGroup.count') do
      post user_groups_url, params: { user_group: { address: @user_group.address, name: @user_group.name, phone_number: @user_group.phone_number } }
    end
  ...
  test "should update user_group" do
    patch user_group_url(@user_group), params: { user_group: { address: @user_group.address, name: @user_group.name, phone_number: @user_group.phone_number } }
